...
const userCtrl = {
    register: async (req, res)=>{
        try {
            ...
            const newUser = new Users({
             ...
             //Create jsonwebtoken authentication
    ...
    login: async (req, res) => {
        try {
            ...
            if(!isMatch) return res.status(400).json({msg: "InCorrect Your Password"})
            //If your login success create token and Refresh Token 
